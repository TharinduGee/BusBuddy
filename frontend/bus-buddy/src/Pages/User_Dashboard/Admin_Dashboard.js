  ...
  return (
    <div>
      <nav class="navbar navbar-light bg-light  p-3">
        ...
        <div class="d-none d-md-block  d-flex align-items-center justify-content-md-end mt-3 mt-md-0">
          <Dropdown class=" ">
            <Dropdown.Toggle
      ...
      <div class="container-fluid">
        <div class="row">
          <nav
            id="sidebar"
            class="col-md-auto col-lg-auto d-md-block bg-light sidebar collapse"
          >
