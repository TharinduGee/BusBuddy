...
function PriceContainer_2() {
  return (
    <div className="d-flex flex-column main-container">
      <div className="package-label">Professional Package</div>
      <div className="price-tag ">$19.99 per month</div>
      <div className="package-name"> Perfect for growing bus businesses</div>
      <Divider
...
export default PriceContainer_2;
