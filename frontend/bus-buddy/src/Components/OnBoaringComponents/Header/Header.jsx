    ...
    <div className="d-flex flex-column whole-page">
      <div className="header-main">
        ...
        <div className="items-labels">
          <a href="#features" className="text-label">
            Features
          </a>
          <a href="#contact" className="text-label">
            Contact
          </a>
          <a href="#subscriptions" className="text-label">
            Subscriptions
          </a>
        ...
        <div className="d-flex flex-row align-items-center me-4">
          ...
          <CustomButton onClick={handleSignUpClick} variant="contained">
            Get started free
          </CustomButton>
        </div>
      </div>
      ...
      <div className="d-flex flex-row  btn-2-div">
        ...
        <Subscriptions href="#subscriptions" variant="contained">
          Subscriptions
        </Subscriptions>
      </div>
