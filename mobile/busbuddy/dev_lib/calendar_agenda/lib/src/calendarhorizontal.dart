...
class CalendarAgendaHorizontal extends StatefulWidget
  ...
  final CalendarAgendaHorizontalController? controller;
  ...
  @override
  CalendarAgendaHorizontalState createState() =>
      CalendarAgendaHorizontalState();

  @override
  Size get preferredSize => new Size.fromHeight(250.0);
}

class CalendarAgendaHorizontalState extends State<CalendarAgendaHorizontal>
...
//backgrounddaylist
  ...
  _initCalendar() {
    if (widget.controller != null &&
        widget.controller is CalendarAgendaHorizontalController) {
