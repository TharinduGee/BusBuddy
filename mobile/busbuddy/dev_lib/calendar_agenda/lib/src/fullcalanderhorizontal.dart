...
class _FullCalendarState extends State<FullCalendar> {
  ...
  Widget daysOfWeek(double width, String? locale, WeekDay? weekday) {
    ...
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        dayName(width / 16, daysNames[0]),
        dayName(width / 16, daysNames[1]),
        dayName(width / 16, daysNames[2]),
        dayName(width / 16, daysNames[3]),
        dayName(width / 16, daysNames[4]),
        dayName(width / 16, daysNames[5]),
        dayName(width / 16, daysNames[6]),
      ],
    );
  }
